...
* **Time-Series & Forecasting** — ARIMA, exponential smoothing, Prophet, seasonal decomposition (STL), changepoint detection, autocorrelation analysis, lag features
* **Survival & Causal Analysis** — Kaplan-Meier curves
* **Interpretability & Explainability** — SHAP values, feature importance
* **Advanced Techniques** — Anomaly detection, behavioral segmentation, dimensionality reduction (PCA, t-SNE, UMAP), ensemble methods, hyperparameter tuning (Optuna, GridSearch)
* **Core Libraries** — pandas, NumPy, scikit-learn, scipy, statsmodels
* **Visualization** — matplotlib, seaborn, Plotly, ggplot
* **Data Processing** — regex, BeautifulSoup, requests, Apache Spark (basics)
* **Model Evaluation** — cross-validation, confusion matrices, ROC-AUC, precision-recall, F1, KL-divergence
...
* **Strategy & Roadmapping** — go-to-market planning, acquisition channels, retention metrics (DAU/MAU), growth frameworks
* **Execution** — OKRs, KPIs, performance tracking, iterative design, A/B testing frameworks
